...
> 下面这张是界面效果示意图(用固定的示例好友摆拍的，方便一眼看清结构)；真实运行时地图和好友都是数据库里的真实数据。

<img src="screenshot-map.png" width="360" alt="主界面：地图 + 好友气泡 + 底部好友列表" />

点击好友头像会弹出详情卡片，可以聊天或打招呼；按住底部抽屉的横杠往上滑，能拉出完整好友列表；点自己的头像可以切换状态(在家 / 工作中 / 吃饭中 / 放松中 / 散步中)。

登录页长这样(这张是真实运行截图)：

<img src="screenshot-login.png" width="360" alt="登录 / 注册界面" />
